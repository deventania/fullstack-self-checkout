...
-- AddForeignKey
ALTER TABLE "OrderPeoduct" ADD CONSTRAINT "OrderPeoduct_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OrderPeoduct" ADD CONSTRAINT "OrderPeoduct_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;
